    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('heading') ? 'is-invalid' : '' }}" type="text" name="heading" id="heading" value="{{ old('heading', $product->heading) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="text" name="height" id="height" value="{{ old('height', $product->height) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('width') ? 'is-invalid' : '' }}" type="text" name="width" id="width" value="{{ old('width', $product->width) }}" required>
                @if($errors->has('width'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Product::STOCK_AVAILABLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('stock_available') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="stock_available_{{ $key }}" name="stock_available" value="{{ $key }}" {{ old('stock_available', $product->stock_available) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_days') ? 'is-invalid' : '' }}" type="text" name="delivery_days" id="delivery_days" value="{{ old('delivery_days', $product->delivery_days) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meta_keywords') ? 'is-invalid' : '' }}" name="meta_keywords" id="meta_keywords">{{ old('meta_keywords', $product->meta_keywords) }}</textarea>
