...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.productCategory.fields.status') }}</label>
            ...
            <div class="form-group">
                <label for="bottom_content">{{ trans('cruds.productCategory.fields.bottom_content') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('bottom_content') ? 'is-invalid' : '' }}" name="bottom_content" id="bottom_content">{!! old('bottom_content', $productCategory->bottom_content) !!}</textarea>
                @if($errors->has('bottom_content'))
                    <span class="text-danger">{{ $errors->first('bottom_content') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.productCategory.fields.bottom_content_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="meta_keywords">{{ trans('cruds.productCategory.fields.meta_keywords') }}</label>
                <textarea class="form-control {{ $errors->has('meta_keywords') ? 'is-invalid' : '' }}" name="meta_keywords" id="meta_keywords">{{ old('meta_keywords', $productCategory->meta_keywords) }}</textarea>
