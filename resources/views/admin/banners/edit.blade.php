...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.banners.update", [$banner->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="link_title">{{ trans('cruds.banner.fields.link_title') }}</label>
                <input class="form-control {{ $errors->has('link_title') ? 'is-invalid' : '' }}" type="text" name="link_title" id="link_title" value="{{ old('link_title', $banner->link_title) }}">
                @if($errors->has('link_title'))
                    <span class="text-danger">{{ $errors->first('link_title') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.banner.fields.link_title_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Banner::STATUS_SELECT as $key => $label)
